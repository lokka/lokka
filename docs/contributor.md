...
<p>Lokka is open source software. Everyone can participate in the development of Lokka in the code and the design and documentation, etc. (Japanese and an English document of this official site also exactly wants the cooperator. )</p>

<h3>One line rule</h3>

<p>If you send code only one line, We are welcome. If it merged, you become a committer. (Github repos's collaborator)</p>
